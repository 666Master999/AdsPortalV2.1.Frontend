...
А  порт ВСЕГДА - http://localhost:5173/ in the integrated browser. ТОлько он работает с контрактами и патчами. Ты не можешь использовать другие порты, даже если они открыты.
❗ Не объясняешь
